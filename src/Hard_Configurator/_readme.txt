...
Distribution
Hard_Configurator may be freely distributed (but not sell) as long as no modification is made to it. Hard_Configurator can use as external software Sysinternals Autoruns, NirSoft FullEventLogView, and command line 7-ZIP, that have their own Software License Terms .
