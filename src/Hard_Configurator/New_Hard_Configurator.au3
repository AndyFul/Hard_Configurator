...
#AutoIt3Wrapper_Res_LegalCopyright=Copyright *  Andrzej Pluta (@Andy Ful) , February 2020
#EndRegion ;**** Directives created by AutoIt3Wrapper_GUI ****

;#pragma compile(Icon, C:\Windows\Hard_Configurator\Skins\Icons\security.ico)

Global $LegalCopyright = "Copyright *  Andrzej Pluta (@Andy Ful) , February 2020"
Global $Hard_ConfiguratorVersion = '5.0.0.1'
Global $SwitchDefaultDenyVersion = '2.0.0.1'
...
$Button1 = GUICtrlCreateButton(@crlf & "Default Deny Protection", 45, 59, 230, 40)
...
$Button2 = GUICtrlCreateButton("Documents Anti-Exploit", 45, 124, 230, 40)
GUICtrlSetOnEvent($Button2, "StartDocumentsAntiExploitTool")
GUICtrlSetColor($Button2, 0xffffff)
GUICtrlSetBkColor($Button2, "0x0079cb")
GUICtrlSetFont($Button2, 10, 600, 0, "Arial", 5)

Local $ButtonHelpDocumentsAntiExploit = GUICtrlCreateButton("HELP", 300, 130, 80, 30)
GUICtrlSetOnEvent($ButtonHelpDocumentsAntiExploit, "HelpDocumentsAntiExploitCA")
...
$Button3 = GUICtrlCreateButton(@crlf & "Validate Admin Code Signatures", 45, 189, 230, 40)
GUICtrlSetOnEvent($Button3, "HelpSDD_ValidateAdminCodeSignatures")
...
If ($LowerExeRestrictions = "ON" And (@OSVersion="WIN_7" Or @OSVersion="WIN_VISTA")) Then
...
;     Backup the values of DefaultLevel, TransparentEnabled and settings related to <Update Mode>, <Harden Archives>,
...
;      MsgBox(262144,'','Software Restriction Policies are going to be deactivated.')
   ...
   Else
;     Restore the last values of DefaultLevel, TransparentEnabled,<Update Mode>, <Harden Archivers>, <Harden Email Clients>
...
Func Recommended_Settings()
  ...
  If $x = 2 Then RegDelete("HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\Explorer", "HideRunAsVerb")
  ShowRegistryTweaks()
EndFUnc
...
Local $text1 = "The <Default Deny Protection> feature works only when Software Restrictions Policies are properly activated in Hard_Configurator. It can be useful for inexperienced users, when there are problems with application installations via 'Install By SmartScreen' or 'Run as administrator' features. In such case, the user can use SwitchDefaultDeny to:" & @crlf & "disable Default Deny Protection >> install applications via 'Run By SmartScreen' >> enable Default Deny Protection." & @crlf &  @crlf & "When switching to the OFF setting, this utility simply changes SRP Default Security Level to Unrestricted, enables 'Run By SmartScreen' entry in the Explorer context menu, and adds the autorun entry to start with Windows." & @crlf &  @crlf & "When switching to the ON setting, it restores the old SRP Default Security Level setting ('Basic User' or 'Disallowed'), restores the old 'Install By SmartScreen' entry in the Explorer context menu, and removes the autorun entry."
Local $text2 = ""
Local $text3 = ""
_SetTheme("LightTeal")
_GUIDisable($Form1, 70)
...
Local $sMessage = "Please wait a moment."
